# When you can't figure out how not to break stock endings... well, just copy-paste them!
...
label eck_bryce_stockgoodending:
    ...
    call izumimask from _call_izumimask_eckbr1
    
    call optimistcheck from _call_optimistcheck_eckbr1
    ...
    if persistent.brycegoodending == False:
        ...
        call syscheck from _call_syscheck_eckbr1
...
label eck_bryce_stockbadending:
    ...
    call sincethelightswerealreadyon from _call_sincethelightswerealreadyon_eckbr1
    ...
    call izumimask from _call_izumimask__eckbr2
    ...
    if persistent.brycebadending == False:
        ...
        call syscheck from _call_syscheck__eckbr2
